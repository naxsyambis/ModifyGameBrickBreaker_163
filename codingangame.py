...
class Brick(GameObject):
    COLORS = {1: '#17334a', 2: '#2b5d87', 3: '#4288c2'}
...
class Game(tk.Frame):
    def __init__(self, master):
        ...
        self.width = 610
        self.height = 400
        self.canvas = tk.Canvas(self, bg='#80afd6',
                                width=self.width,
                                height=self.height,)
        self.canvas.pack()
        self.pack()
...
class Brick(GameObject):
    COLORS = {1: '#2b5d87', 2: '#17334a', 3: '#03080c'}
...
class Game(tk.Frame):
    ...
    def game_loop(self):
        ...
        if num_bricks == 0: 
            self.ball.speed = None
            self.draw_text(300, 200, 'Kamu Menang! You the Breaker of Bricks.')
        elif self.ball.get_position()[3] >= self.height: 
            self.ball.speed = None
            self.lives -= 1
            if self.lives < 0:
                self.draw_text(300, 200, 'KALAH! Game Over!')
            else:
                self.after(1000, self.setup_game)
        else:
            self.ball.update()
